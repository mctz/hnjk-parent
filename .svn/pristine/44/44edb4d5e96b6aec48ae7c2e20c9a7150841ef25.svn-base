								...
								<table border='0' width="100%">
									...
									<td width="10%">
										<select name="style" size="1">
											...
											<option value="audit"
													<c:if test="${resource.style eq 'audit' }"> selected </c:if>>审核</option>
											<option value="repeal"
													<c:if test="${resource.style eq 'repeal' }"> selected </c:if>>撤销</option>
											<option value="upload"
												<c:if test="${resource.style eq 'upload' }"> selected </c:if>>上传</option>
											...
											<option value="switch"
													<c:if test="${resource.style eq 'switch' }"> selected </c:if>>切换</option>
											<option value="icon"
