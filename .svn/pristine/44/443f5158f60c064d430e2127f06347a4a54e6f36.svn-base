...
<title>${school}${schoolConnectName}-在线帮助 - 查询结果</title>
		...
		<UL>
			...
			<LI style="padding-left: 12px; width: 100%">
				<table border="0" cellpadding="0" cellspacing="0" class="STYLE2"
					style="width: 99%">
					<c:forEach items="${helpArticles.result}" var="helpArticle"
						varStatus="vs">
						<tr>
							<td align="left" width="75%"
								...
								<a
								href="${baseUrl}/portal/help/detail.html?id=${helpArticle.resourceid}&tags=${tags}">${helpArticle.title}</a>
							</td>
					...
					<tr>
						<td align="center">
							<form action="" method="post">
								<gh:page page="${helpArticles}" pageType="other"
									condition="${condition }" />
							</form>
						</td>
					</tr>
