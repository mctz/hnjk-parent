...
<title>${school}${schoolConnectName}- ${article.title }</title>
							...
							<table width="147" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td style="padding-top: 6px">&nbsp;<span
										style="margin-left: 30px; margin-top: 22px; font-size: 11pt">${currentChannel.channelName }</span></td>
								</tr>
								<tr>
						...
						<td valign="top"><table width="816" height="30" border="0"
								...
								<tr>
									<td height="30"><span class="STYLE4">当前位置：<a
											href="#">${currentChannel.channelName}</a></span></td>
								</tr>
							</table></td>
					</tr>
					<tr>
						<td height="324" align="left" valign="top">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="16" align="center" class="detail_title2">${article.orgUnit.unitName}
	                	 	...
	                	 	附件${vs.index+1}： <a
											...
											<tr>
												<td height="16" align="center" class="detail_title2"
													style="text-align: right">来源：${article.source}</td>
											</tr>
											<tr>
												<td height="12" align="center" valign="top">&nbsp;</td>
											</tr>
