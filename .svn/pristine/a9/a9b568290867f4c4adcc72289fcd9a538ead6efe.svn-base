	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#setTeacher").click(function(){
				...
				navTab.reload(url1+'?courseDetailid='+resId+'&brSchoolid='+brSchoolid+'&teachCourseid='+teachCourseid+'&templateid='+templateid+'&teacherids='+teacherIds+'&teacherNames='+setteacherNames+"&classroomType="+classroomType+'&classroomid='+classroomid+'&weekOrDate='+weekOrDate+"&days="+days+"&weeks="+weeks+"&timePeriod="+timePeriod+"&isArrange="+isArrange, {}, 'RES_ARRANGE_COURSEDETAIL_EDIT');
			});
		});
