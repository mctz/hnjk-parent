...
jQuery(document).ready(function(){
	$("#importTeacherForm input[name='submit']").show();
	$("#importTeacherForm input[name='submiting']").hide();
});
   ...
   // DWZ.ajaxDone(data);
    ...
    function checkDivideFilePath(){
    	var impValue = jQuery("#importTeacherForm #importFile").val();
    	if(impValue==""){
    ...
    function checkFileType(){
    	...
    	$("#importTeacherForm input[name='submit']").hide();
    	$("#importTeacherForm input[name='submiting']").show();
...
<body>
	<div class="page">
		<div class="pageContent">
			...
			<form method="post" id="importTeacherForm"
				action="${baseUrl}/edu3/teaching/edumanager/import.html?act=import"
				...
				<table class="form">
					<tr>
						<td colspan="2">
							...
							<p>1、导入的excel必须是2003版本或其以下的版本;</p> <!-- <p>2、导入课室信息必须按照导出的课室信息列表排序;</p>
					      <p>3、班级列中请输入班级名称全称;</p>
					...
					<tr>
						<td colspan="2"><input type="submit" value="提交"
							onclick="return checkDivideFilePath()" name="submit"
							style="cursor: pointer;" /> <input type="button"
							style="color: green" value="正在提交...请耐心等待..." name="submiting"
							disabled="true" /></td>
					</tr>
				</table>
			</form>
