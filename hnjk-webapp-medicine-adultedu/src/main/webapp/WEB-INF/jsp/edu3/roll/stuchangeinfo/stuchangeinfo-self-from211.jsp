...
*/
		  ...
		  if("${finished}"=='Y'){
			...
			var stuno=$("#stuChangeForStu input[id='stuNum']").val();
			if(stuno==""){
				 $("#stuChangeForStu input[id='stuNum']").val($("#stuchangeid").val());
			...
			$.ajax({
				...
				success:function(data){
					if(data.error && data.error!=""){
						...
						$("#sstuName").append(data.studentName);
...
//		$("#changeSchool_majorName").attr("class","");
...
//			$("#changeSchool_majorName").attr("class","required");
	//	    $("#changeSchool_classesid").attr("class","");
...
//				$("#changeSchool_classesid").html(cleanhtml);
	...
	function _selectTeachPlan_changeSchool(){
		...
		jQuery.ajax({
			data:"brSchoolId="+brSchoolId+"&studentresourceid="+studentresourceid+"&majorId="+majorId,
			dataType:"json",
			url:"${baseUrl}/edu3/framework/register/stuchangeinfo/getguidteachplan.html",
			success:function(data){
				if(data.error && data.error!=""){
	...
	<div class="page">
		<div class="pageContent">
			<form method="post"
				...
				onsubmit="return validateCallback1(this);">
						...
						<div class="tabsContent" style="height: 100%;">
							<div>
								<table class="form" id="changeTab">
									...
									<input type="hidden" id="stuchangeid" value="${stuchangeId}">
									<tr>
										<td width="10%">变动类别:</td>
										...
										<td width="10%">学号:</td>
										<td width="25%" id="stuChangeForStu"><span id="sstuNum">${stuchangeId}</span>
											...
											class="required" /></td>
										<td width="10%">姓名:</td>
										<td width="22%"><span id="sstuName"></span> <input
											type="hidden" id="stuName" name="stuName" style="width: 50%"
									...
									<tr style="display: none" name="33D">
										...
										<td width="25%">
											...
											<input type="hidden" id="changeMajor_TeachingTypeid"
											name="changeMajor_TeachingTypeid"
											value="${stuChangeInfo.changeTeachingType}" /> <span
											id="changeMajor_TeachingType">${ghfn:dictCode2Val('CodeTeachingType',stuChangeInfo.changeTeachingType)}</span>
										</td>
										<td width="10%"></td>
										<td width="22%"></td>
									</tr>
									<tr style="display: none" name="55D">
										...
										<td width="10%">异动后学习形式:</td>
										<td width="25%"><input type="hidden"
											id="changeSchool_TeachingTypeid"
											name="changeSchool_TeachingTypeid"
											value="${stuChangeInfo.changeTeachingType}" /> <span
											id="changeSchool_TeachingType">${ghfn:dictCode2Val('CodeTeachingType',stuChangeInfo.changeTeachingType)}</span>
										</td>
										<td width="10%"></td>
										<td width="22%"></td>
									</tr>
									...
									<tr id="G" style="display: none">
										...
										<td width="90%" colspan="5"><span><fmt:formatDate
													value="${stuChangeInfo.backSchoolDate}"
													pattern="yyyy-MM-dd" /></span></td>
									</tr>
									<tr style="display: none" name="22G">
										<td width="10%">复学日期:</td>
										<td width="90%" colspan="5"><input type="text"
											id="backSchool_backSchoolDate"
											name="backSchool_backSchoolDate"
											value="${stuChangeInfo.backSchoolDate}" class="Wdate"
											onfocus="WdatePicker({minDate:'${currentDate}'})" /></td>
									</tr>
									<tr style="display: none" name="88G">
										<td width="10%">复学日期:</td>
										<td width="90%" colspan="5"><input type="text"
											id="pauseStudy_backSchoolDate"
											name="pauseStudy_backSchoolDate"
											value="${stuChangeInfo.backSchoolDate}" class="Wdate"
											onfocus="WdatePicker({minDate:'${currentDateAfter}'})" /></td>
									</tr>
									...
									<tr>
										<td width="10%">操作员:</td>
										<td width="90%" colspan="5"><input type="hidden"
