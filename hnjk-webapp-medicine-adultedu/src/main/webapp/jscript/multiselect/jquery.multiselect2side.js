		...
		return this.each(function () {
			...
			var divUpDown =
					"<div class='ms2side__updown'>" +
						"<p class='SelSort' title='排序'>" + o.labelSort + "</p>" +
						"<p class='MoveTop' title='移动一个选项到最上'>" + o.labelTop + "</p>" +
						"<p class='MoveUp' title='向上移动一个选项'>" + o.labelUp + "</p>" +
						"<p class='MoveDown' title='向下移动一个选项'>" + o.labelDown + "</p>" +
						"<p class='MoveBottom' title='移动一个选项到最下'>" + o.labelBottom + "</p>" +
					"</div>";
			...
			var htmlToAdd = 
				"<div class='ms2side__div'>" +
					...
					"<div class='ms2side__options'>" +
						...
						?
						("<p class='AddOne' title='添加'>添加 &rsaquo;</p>" +
						"<p class='AddAll' title='全部添加'>全部添加 &raquo;</p>" +
						"<p class='RemoveOne' title='移除'>&lsaquo; 移除</p>" +
						"<p class='RemoveAll' title='全部移除'>&laquo; 全部移除</p>")
						:
						("<p class='AddOne' title='添加'>&lsaquo; 添加 </p>" +
						"<p class='AddAll' title='全部添加'>&laquo; 全部添加</p>" +
						"<p class='RemoveOne' title='移除'>移除 &rsaquo;</p>" +
						"<p class='RemoveAll' title='全部移除'>全部移除 &raquo;</p>")
						) +
					"</div>" +
					"<div class='ms2side__select'>" +
