...
$.blockUI.defaults = {
    ...
    //message:  "<img src=\'"+baseUrl+"/images/framework/loading.gif'/>",
    message:  "<img src=\'"+baseUrl+"/jscript/blockui/busy3.gif'/>",
    ...
    css: {
        padding:        0,
        margin:         0,
        //width:          '10%', /* message层的宽度,可以根据要显示的message内容不同修改合适的大小 */
        //height:         '10%', /* message层的高度(不使用此属性,则默认以message的内容为大小) */
        top:            '40%',
        left:           '40%',
        textAlign:      'center',
        color:          '#000',  /* message的前景色 */
        border:         '0px solid #ddd',  /*message层的边框样式*/
        //backgroundColor:'#ece3e3', /* message显示层的背景色 */
        cursor:         'default'
    },

    // styles for the overlay
    overlayCSS:  {
        backgroundColor: '#ccc', /* block的背景色 */
        opacity:         '0.6'   /* 透明度 */
    },
...
function install(el, opts) {
    ...
    var lyr2 = $('<div class="blockUI blockOverlay" style="z-index:'+ (z++) +';display:none;cursor:default;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
