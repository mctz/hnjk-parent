	...
	<div class="page">
		<div class="pageHeader">
			<form onsubmit="return navTabSearch(this);"
				action="${baseUrl }/edu3/recruit/recruitmanage/enrollStatisticPlace.html"
				method="post">
				<div class="searchBar">
		...
		<div class="pageContent" layoutH="71">
			...
			<table class="list" style="width: 96%">
				...
				<tbody>
					<c:forEach items="${enrollPList}" var="p" varStatus="vs">
						<tr>
							<td>${vs.index+1 }</td>
							<td>${p['homeplace'] }&nbsp;</td>
							<td>${p['STU_NUM'] }&nbsp;</td>
