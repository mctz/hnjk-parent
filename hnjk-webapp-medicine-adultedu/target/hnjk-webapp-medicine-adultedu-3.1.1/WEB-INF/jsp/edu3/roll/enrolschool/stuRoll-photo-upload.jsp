...
<title>导入考生相片</title>
<style type="text/css">
#stuRoll_photo_messageTbody .success {
	color: green;
}

#stuRoll_photo_messageTbody .error {
	color: red;
}
</style>
<script type="text/javascript">	   
	   function StuRollPhotoValidateCallback(form){
		   var grade="";
		   grade = $("#gradeid").val();
		   if(grade==""){
			   alertMsg.warn("请选择年级");
...
// 					}
					var $table = $("#stuRoll_photo_messageTbody");
					$table.html("");//清空
...
<body>
	<h2 class="contentTitle">导入学生相片</h2>
	<div class="page">
		<div class="pageContent">
			<form method="post"
				action="${baseUrl}/edu3/roll/studentinfo/stuRollPhotoimport.html"
				class="pageForm"
				onsubmit="return StuRollPhotoValidateCallback(this);">
				...
				<div class="pageFormContent" layoutH="97">
					<table class="form">
						<tr>
							...
							<td>${gradeselect }
						<tr>
							<td width="20%">学生相片(请打包为zip):</td>
							<td><gh:upload hiddenInputName="attachId"
									uploadType="attach" baseStorePath="upload" isMulti="false"
									uploadLimit="1" formType="StuRollPhotoImport" fileExt="zip" />
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<table class="list" width="100%">
									<tbody id="stuRoll_photo_messageTbody"></tbody>
								</table>
							</td>
						</tr>
					</table>
