 ...
 * @version 1.0
 */
public class IreportViewTag extends BaseTagSupport{
	...
	public int doStartTag() throws JspException {
		try {
			Template template = FreeMarkerConfig.getDefaultTemplate("system"+File.separator+"ireportview.ftl");;
			...
			logger.error("输出查看预览出错：{}",e.fillInStackTrace());
		}
		return EVAL_PAGE;
	}
