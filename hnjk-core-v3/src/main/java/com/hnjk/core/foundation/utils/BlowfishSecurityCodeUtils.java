...
/**
 * 提供一个基于blowfish的加密算法. <p>
 * 使用方法：
 * <pre>{@code
      	String keyString = "www.gdcn.com";//通常这个值是动态的
		String testString = "广东数网";
		BlowfishSecurityCodeUtils crypt = new BlowfishSecurityCodeUtils(keyString);		
		System.out.println("加密前**************\n" + "testString = " + testString);//明文		
		System.out.println("开始加密");
		testString = crypt.encryptString(testString);		
    	System.out.println("加密之后**************\n" + "testString = "+ testString);//生产密文		
		System.out.println("开始解密");
		testString = crypt.decryptString(testString);
		System.out.println("解密之后**************\n" + "testString = "+ testString);//解密->明文
		}
	</pre>
 * @author： 广东学苑教育发展有限公司.
 * @since： 2009-2-25下午03:10:34
 * @version 1.0
 */
public class BlowfishSecurityCodeUtils {
	...
	private static class BlowfishCBC extends BlowfishECB {
		...
		public void getCBCIV(byte[] dest) {
			BlowfishSecurityCodeUtils.longToByteArray(m_lCBCIV, dest, 0);
		}
		...
		public void setCBCIV(byte[] newCBCIV) {
			m_lCBCIV = BlowfishSecurityCodeUtils.byteArrayToLong(newCBCIV, 0);
		}
		...
		public void encrypt(byte[] inbuffer, byte[] outbuffer) {
			...
			for (int nI = 0; nI < nLen; nI += 8) {
				long lTemp = BlowfishSecurityCodeUtils.byteArrayToLong(inbuffer, nI);
				lTemp = encryptBlockCBC(lTemp);
				BlowfishSecurityCodeUtils.longToByteArray(lTemp, outbuffer, nI);
			}
		...
		public void encrypt(byte[] buffer) {
			...
			for (int nI = 0; nI < nLen; nI += 8) {
				long lTemp = BlowfishSecurityCodeUtils.byteArrayToLong(buffer, nI);
				lTemp = encryptBlockCBC(lTemp);
				BlowfishSecurityCodeUtils.longToByteArray(lTemp, buffer, nI);
			}
		...
		public void encrypt(int[] inbuffer, int[] outbuffer) {
			...
			for (int nI = 0; nI < nLen; nI += 2) {
				long lTemp = BlowfishSecurityCodeUtils.intArrayToLong(inbuffer, nI);
				lTemp = encryptBlockCBC(lTemp);
				BlowfishSecurityCodeUtils.longToIntArray(lTemp, outbuffer, nI);
			}
		...
		public void encrypt(int[] buffer) {
			int nLen = buffer.length;
			for (int nI = 0; nI < nLen; nI += 2) {
				long lTemp = BlowfishSecurityCodeUtils.intArrayToLong(buffer, nI);
				lTemp = encryptBlockCBC(lTemp);
				BlowfishSecurityCodeUtils.longToIntArray(lTemp, buffer, nI);
			}
	...
	private static class BlowfishECB {
		...
		public static boolean selfTest() {
			byte[] testKey1 = {28, 88, 127, 28, 19, -110, 79, -17};
		...
		protected long encryptBlock(long lPlainBlock) {
			int nHi = BlowfishSecurityCodeUtils.longHi32(lPlainBlock);
			int nLo = BlowfishSecurityCodeUtils.longLo32(lPlainBlock);
			int[] sbox1 = m_sbox1;
			int[] sbox2 = m_sbox2;
			int[] sbox3 = m_sbox3;
			int[] sbox4 = m_sbox4;
			...
			return BlowfishSecurityCodeUtils.makeLong(nHi, nLo ^ pbox[17]);
		}

		protected long decryptBlock(long lCipherBlock) {
			int nHi = BlowfishSecurityCodeUtils.longHi32(lCipherBlock);
			int nLo = BlowfishSecurityCodeUtils.longLo32(lCipherBlock);
			nHi ^= m_pbox[17];
			...
			return BlowfishSecurityCodeUtils.makeLong(nHi, nLo ^ m_pbox[0]);
		}
		...
		static final int[] pbox_init = {0x243f6a88, 0x85a308d3, 0x13198a2e,
				0x3707344, 0xa4093822, 0x299f31d0, 0x82efa98, 0xec4e6c89,
				0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c, 0xc0ac29b7,
				0xc97c50dd, 0x3f84d5b5, 0xb5470917, 0x9216d5d9, 0x8979fb1b};

		static final int[] sbox_init_1 = {0xd1310ba6, 0x98dfb5ac, 0x2ffd72db,
				0xd01adfb7, 0xb8e1afed, 0x6a267e96, 0xba7c9045, 0xf12c7f99,
				0x24a19947, 0xb3916cf7, 0x801f2e2, 0x858efc16, 0x636920d8,
				0x71574e69, 0xa458fea3, 0xf4933d7e, 0xd95748f, 0x728eb658,
				...
				0x23893e81, 0xd396acc5, 0xf6d6ff3, 0x83f44239, 0x2e0b4482,
				...
				0x75372c9, 0x80991b7b, 0x25d479d8, 0xf6e8def7, 0xe3fe501a,
				0xb6794c3b, 0x976ce0bd, 0x4c006ba, 0xc1a94fb6, 0x409f60c4,
		...
		static final int[] sbox_init_2 = {0x4b7a70e9, 0xb5b32944, 0xdb75092e,
				...
				0xf0255dc1, 0x4cdd2086, 0x8470eb26, 0x6382e9c6, 0x21ecc5e,
				0x9686b3f, 0x3ebaefc9, 0x3c971814, 0x6b6a70a1, 0x687f3584,
				0x52a0e286, 0xb79c5305, 0xaa500737, 0x3e07841c, 0x7fdeae5c,
				0x8e7d44ec, 0x5716f2b8, 0xb03ada37, 0xf0500c0d, 0xf01c1f04,
				0x200b3ff, 0xae0cf51a, 0x3cb574b2, 0x25837a58, 0xdc0921bd,
				0xd19113f9, 0x7ca92ff6, 0x94324773, 0x22f54701, 0x3ae5e581,
				0x37c2dadc, 0xc8b57634, 0x9af3dda7, 0xa9446146, 0xfd0030e,
				...
				0x81ac77d6, 0x5f11199b, 0x43556f1, 0xd7a3c76b, 0x3c11183b,
				...
				0x97e32d77, 0x11ed935f, 0x16681281, 0xe358829, 0xc7e61fd6,
				...
				0x69cb7492, 0x47848a0b, 0x5692b285, 0x95bbf00, 0xad19489d,
				0x1462b174, 0x23820e00, 0x58428d2a, 0xc55f5ea, 0x1dadf43e,
				...
				0xe1e9ec9, 0xdb73dbd3, 0x105588cd, 0x675fda79, 0xe3674340,
				0xc5c43465, 0x713e38d8, 0x3d28f89e, 0xf16dff20, 0x153e21e7,
				0x8fb03d4a, 0xe6e39f2b, 0xdb83adf7};

		static final int[] sbox_init_3 = {0xe93d5a68, 0x948140f7, 0xf64c261c,
				0x94692934, 0x411520f7, 0x7602d4f7, 0xbcf46b2e, 0xd4a20068,
				0xd4082471, 0x3320f46a, 0x43b7d4b7, 0x500061af, 0x1e39f62e,
				0x97244546, 0x14214f74, 0xbf8b8840, 0x4d95fc1d, 0x96b591af,
				0x70f4ddd3, 0x66a02f45, 0xbfbc09ec, 0x3bd9785, 0x7fac6dd0,
				0x31cb8504, 0x96eb27b3, 0x55fd3941, 0xda2547e6, 0xabca0a9a,
				0x28507825, 0x530429f4, 0xa2c86da, 0xe9b66dfb, 0x68dc1462,
				...
				0x4272f70, 0x80bb155c, 0x5282ce3, 0x95c11548, 0xe4c66d22,
				0x48c1133f, 0xc70f86dc, 0x7f9c9ee, 0x41041f0f, 0x404779a4,
				0x5d886e17, 0x325f51eb, 0xd59bc0d1, 0xf2bcc18f, 0x41113564,
				0x257b7834, 0x602a9c60, 0xdff8e8a3, 0x1f636c1b, 0xe12b4c2,
				0x2e1329e, 0xaf664fd1, 0xcad18115, 0x6b2395e0, 0x333e92e1,
				0x3b240b62, 0xeebeb922, 0x85b2a20e, 0xe6ba0d99, 0xde720c8c,
				0x2da2f728, 0xd0127845, 0x95b794fd, 0x647d0862, 0xe7ccf5f0,
				0x5449a36f, 0x877d48fa, 0xc39dfd27, 0xf33e8d1e, 0xa476341,
				...
				0x782ef11c, 0x6a124237, 0xb79251e7, 0x6a1bbe6, 0x4bfb6350,
				0x1a6b1018, 0x11caedfa, 0x3d25bdd8, 0xe2e1c3c9, 0x44421659,
				0xa121386, 0xd90cec6e, 0xd5abea2a, 0x64af674e, 0xda86a85f,
				...
				0x662d09a1, 0xc4324633, 0xe85a1f02, 0x9f0be8c, 0x4a99a025,
				0x1d6efe10, 0x1ab93d1d, 0xba5a4df, 0xa186f20f, 0x2868f169,
				0xdcb7da83, 0x573906fe, 0xa1e2ce9b, 0x4fcd7f52, 0x50115e01,
				0xa70683fa, 0xa002b5c4, 0xde6d027, 0x9af88c27, 0x773f8641,
				0xc3604c06, 0x61a806b5, 0xf0177a28, 0xc0f586e0, 0x6058aa,
				0x30dc7d62, 0x11e69ed7, 0x2338ea63, 0x53c2dd94, 0xc2c21634,
				0xbbcbee56, 0x90bcb6de, 0xebfc7da1, 0xce591d76, 0x6f05e409,
				0x4b7c0188, 0x39720a3d, 0x7c927c24, 0x86e3725f, 0x724d9db9,
				0x1ac15bb4, 0xd39eb8fc, 0xed545578, 0x8fca5b5, 0xd83d7cd3,
				0x4dad0fc4, 0x1e50ef5e, 0xb161e6f8, 0xa28514d9, 0x6c51133c,
				0x6fd5c7e7, 0x56e14ec4, 0x362abfce, 0xddc6c837, 0xd79a3234,
				0x92638212, 0x670efa8e, 0x406000e0};

		static final int[] sbox_init_4 = {0x3a39ce37, 0xd3faf5cf, 0xabc27737,
				...
				0x9e34d797, 0x2cf0b7d9, 0x22b8b51, 0x96d5ac3a, 0x17da67d,
				...
				0x3a16125, 0x564f0bd, 0xc3eb9e15, 0x3c9057a2, 0x97271aec,
				0xa93a072a, 0x1b3f6d9b, 0x1e6321f5, 0xf59c66fb, 0x26dcf319,
				0x7533d928, 0xb155fdf5, 0x3563482, 0x8aba3cbb, 0x28517711,
				...
				0xa2ae0810, 0xdd6db224, 0x69852dfd, 0x9072166, 0xb39a460a,
				...
				0x34d2466a, 0x115af84, 0xe1b00428, 0x95983a1d, 0x6b89fb4,
				0xce6ea048, 0x6f3f3b82, 0x3520ab82, 0x11a1d4b, 0x277227f8,
				...
				0xd50ada38, 0x339c32a, 0xc6913667, 0x8df9317c, 0xe0b12b4f,
				0xf79e59b7, 0x43f5bb3a, 0xf2d519ff, 0x27d9459c, 0xbf97222c,
				0x15e6fc2a, 0xf91fc71, 0x9b941525, 0xfae59361, 0xceb69ceb,
				...
				0xe60b6f47, 0xfe3f11d, 0xe54cda54, 0x1edad891, 0xce6279cf,
				...
				0x4cf9aa7e, 0x1948c25c, 0x2fb8a8c, 0x1c36ae4, 0xd6ebe1f9,
	...
	public BlowfishSecurityCodeUtils(String password) {
	...
	private String encStr(String sPlainText, long lNewCBCIV) {
		...
		return bytesToBinHex(newCBCIV, 0, 8)
	...
	private static String byteArrayToUNCString(byte[] data, int nStartPos,
		...
		for (; nNumOfBytes > 0; nNumOfBytes -= 2) {
			sbuf.setCharAt(nSBufPos++,
					(char) (data[nStartPos] << 8 | data[nStartPos + 1] & 0xff));
			nStartPos += 2;
		}
